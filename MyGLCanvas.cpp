...
void MyGLCanvas::drawScene() {
	...
	glUniform1f(glGetUniformLocation(myShaderManager->getShaderProgram("objectShaders")->programID, "scaleFactor"), scaleFactor);
	glUniform1f(glGetUniformLocation(myShaderManager->getShaderProgram("objectShaders")->programID, "myBlend"), textureBlend);
	glUniform1f(glGetUniformLocation(myShaderManager->getShaderProgram("objectShaders")->programID, "useDiff"), useDiffuse);
	...
	glUniform1f(glGetUniformLocation(myShaderManager->getShaderProgram("environmentShaders")->programID, "scaleFactor"), scaleFactor);
